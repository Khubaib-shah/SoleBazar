...
export default function ProductsPage() {
    return (
        <main className="min-h-screen bg-[#FAFAF7]">
            ...
            <div className="bg-[#2B2B2B] py-20 text-white relative overflow-hidden z-0">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black mb-6">ALL <span className="text-[#7C8C5C]">PRODUCTS</span></h1>
